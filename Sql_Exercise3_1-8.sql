...
insert into penalties values (1,6,'08-Dec-80',100.0);
insert into penalties values (2,44,'05-May-81',75.0);
insert into penalties values (3,27,'10-Sep-83',100.0);
insert into penalties values (4,104,'08-Dec-84',50.0);
insert into penalties values (5,44,'08-Dec-80',25.0);
insert into penalties values (6,8,'08-Dec-80',25.0);
insert into penalties values (7,44,'30-Dec-82',30.0);
insert into penalties values (8,27,'12-Dec-84',75.0);
...
SELECT PLAYERNO, NAME, YEAR_OF_BIRTH From PLAYERS
    WHERE ((MOD(YEAR_OF_BIRTH,4) = 0 AND MOD(YEAR_OF_BIRTH,100) != 0 ) OR MOD(YEAR_OF_BIRTH,400) = 0);
